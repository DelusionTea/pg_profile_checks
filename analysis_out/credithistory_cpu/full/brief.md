...
report_count: 2
stable_findings_count: 15
tuning_recommendations_count: 11
...
- example: credithistory: idle_in_transaction_time=13277.7s (threshold 3600s), idle_in_transaction_session_timeout=0
...
- example: postgres.pgse_profile.sample_statements: table hit_pct=92.80% (threshold 95.0%)
- problem: Review cache hit ratios and disk read patterns.
- GUC `shared_buffers` → increase [safety=restart_required, impact=high] current: prom1=382464, prom2=382464
...
- GUC `effective_cache_size` → review_increase [safety=safe, impact=low] current: prom1=1147520, prom2=1147520
...
- stability: 2/2 (100%) in prom1, prom2
- change_safety: restart_required | change_impact: high
- example: Checkpoint write time: 11518.9s over 24.0h interval (threshold 300s)
...
- GUC `shared_buffers` → review_increase [safety=restart_required, impact=high] current: prom1=382464, prom2=382464
...
- example: postgres/postgres: mean=2796.9ms, total=134.2s, calls=48
...
- finding_ids: autovacuum.table_high_dead_pct
- stability: 2/2 (100%) in prom1, prom2
- change_safety: cautious | change_impact: medium
- example: credithistory.credithistory.t_value: dead_pct=13.9%, n_dead=1392350, last_autovacuum=2026-07-06 08:45:17.991906+03
...
- GUC `maintenance_work_mem` → increase [safety=cautious, impact=medium] current: prom1=1223680, prom2=1223680
...
- stability: 2/2 (100%) in prom1, prom2
- change_safety: cautious | change_impact: medium
- example: wal_buffers_full: 7260 (threshold 1000)
...
- stability: 2/2 (100%) in prom1, prom2
- change_safety: cautious | change_impact: medium
- example: credithistory.credithistory.t_dspc_sys_versions: seq_scan=69096, idx_scan=0, ratio=69096.0
- problem: Много seq scan при низком idx_scan — возможно отсутствует индекс
- GUC `random_page_cost` → review_decrease_ssd [safety=cautious, impact=medium] current: prom1=2, prom2=2
...
- GUC `effective_io_concurrency` → increase [safety=cautious, impact=low] current: prom1=300, prom2=300
...
- example: credithistory: blk_read_time=117.1s (threshold 60s)
- problem: Review cache hit ratios and disk read patterns.
- actions:
  - Identify tables with high physical reads
...
- stability: 2/2 (100%) in prom1, prom2
- change_safety: safe | change_impact: low
- example: credithistory.credithistory.t_value: heap_blks_read=187664
...
- stability: 2/2 (100%) in prom1, prom2
- change_safety: safe | change_impact: low
- example: Unused index credithistory.credithistory.t_value.i_value_rquid: size=845 MB
...
- [warning] autovacuum.generic: 1/2 — prom2
- [warning] autovacuum.table_high_mods_pct: 1/2 — prom1
- [warning] cache.low_hit_ratio: 1/2 — prom2
