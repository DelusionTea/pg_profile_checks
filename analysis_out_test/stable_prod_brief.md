...
- counteragent_prom2: counteragent_prom2.html
  server: pslod-pprb00796.cloud.omega.sbrf.ru
...
- stability: 2/2 (100%) in counteragent_prom1, counteragent_prom2
...
- GUC `idle_in_transaction_session_timeout` → set_nonzero [safety=cautious, impact=medium] current: counteragent_prom1=0, counteragent_prom2=0
...
- GUC `shared_buffers` → increase [safety=restart_required, impact=high] current: counteragent_prom1=1026816, counteragent_prom2=1026816
...
- GUC `effective_cache_size` → review_increase [safety=safe, impact=low] current: counteragent_prom1=3145728, counteragent_prom2=3145728
...
- GUC `work_mem` → review_decrease_or_role_level [safety=risky, impact=high] current: counteragent_prom1=16384, counteragent_prom2=16384
...
- GUC `checkpoint_completion_target` → review_increase [safety=safe, impact=low] current: counteragent_prom1=0.5, counteragent_prom2=0.5
...
- GUC `shared_buffers` → review_increase [safety=restart_required, impact=high] current: counteragent_prom1=1026816, counteragent_prom2=1026816
...
- GUC `work_mem` → review_increase_role_level [safety=risky, impact=high] current: counteragent_prom1=16384, counteragent_prom2=16384
...
- GUC `max_wal_size` → increase [safety=cautious, impact=medium] current: counteragent_prom1=16384, counteragent_prom2=16384
...
- GUC `autovacuum_naptime` → decrease [safety=cautious, impact=medium] current: counteragent_prom1=10, counteragent_prom2=10
...
- GUC `autovacuum_vacuum_cost_delay` → decrease [safety=cautious, impact=medium] current: counteragent_prom1=10, counteragent_prom2=10
...
- GUC `autovacuum_vacuum_cost_limit` → increase [safety=cautious, impact=medium] current: counteragent_prom1=1000, counteragent_prom2=1000
...
- GUC `maintenance_work_mem` → increase [safety=cautious, impact=medium] current: counteragent_prom1=3354624, counteragent_prom2=3354624
...
- GUC `wal_buffers` → increase [safety=cautious, impact=medium] current: counteragent_prom1=2048, counteragent_prom2=2048
...
- GUC `max_wal_size` → review [safety=cautious, impact=medium] current: counteragent_prom1=16384, counteragent_prom2=16384
...
- GUC `statement_timeout` → set_nonzero [safety=safe, impact=low] current: counteragent_prom1=0, counteragent_prom2=0
...
- GUC `lock_timeout` → set_nonzero [safety=safe, impact=low] current: counteragent_prom1=0, counteragent_prom2=0
...
- [warning] autovacuum.generic: 1/2 — counteragent_prom1
- [warning] io.high_seq_scan: 1/2 — counteragent_prom2
- [critical] sessions.abnormal_termination: 1/2 — counteragent_prom2
- [warning] sessions.high_rollback_ratio: 1/2 — counteragent_prom2
