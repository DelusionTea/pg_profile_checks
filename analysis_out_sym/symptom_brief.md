...
- reports: counteragent_prom1, counteragent_prom2
- evidence:
  - [counteragent_prom1] Топ CPU: sum_cpu_time=6050.2s, user_time_pct=9.7%
  - [counteragent_prom1] hex=11a74fb9c1776a85: update counteragent.t_transaction set sys_lastchangedate=$1,rquid=$2,validto=$3 …
  - [counteragent_prom1] #2: sum_cpu_time=5432.9s hex=a1fcd5d63d26f0a7
  - [counteragent_prom1] #3: sum_cpu_time=5214.5s hex=541f3e835c8bf2f3
  - [counteragent_prom2] Топ CPU: sum_cpu_time=6904.7s, user_time_pct=13.3%
- confirm:
...
- reports: counteragent_prom1, counteragent_prom2
- evidence:
  - [counteragent_prom1] Высокий объём: calls=28,399,920, total_exec_time=77554.6s, mean=2.73ms hex=11a74fb9c1776a85
  - [counteragent_prom1] Высокий объём: calls=39,694,024, total_exec_time=44526.3s, mean=1.12ms hex=541f3e835c8bf2f3
  - [counteragent_prom1] Высокий объём: calls=24,696,855, total_exec_time=24938.1s, mean=1.01ms hex=9caf3ac0769402eb
  - [counteragent_prom1] Высокий объём: calls=24,812,094, total_exec_time=17363.3s, mean=0.70ms hex=bd7c3f63db986839
  - [counteragent_prom1] Высокий объём: calls=34,406,203, total_exec_time=11478.1s, mean=0.33ms hex=a1fcd5d63d26f0a7
- confirm:
...
- reports: counteragent_prom1, counteragent_prom2
- evidence:
  - [counteragent_prom1] checkpoints_req=181, checkpoint_write_time=22768.8s
  - [counteragent_prom2] checkpoints_req=154, checkpoint_write_time=21018.5s
- confirm:
...
- reports: counteragent_prom1, counteragent_prom2
- evidence:
  - [counteragent_prom1] Bloat: counteragent.t_clientfeaturemapping dead_pct=53.591401043550135%
  - [counteragent_prom2] Bloat: pgse_profile.sample_statements dead_pct=16.300568821413986%
- confirm:
