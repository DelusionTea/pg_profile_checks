...
- nt2: pgprofile_srv=10_3_81_94_from=2026_08_11_16_30_to=2026_08_12_09.html
  server: tsldd-pprb01138.delta.sbrf.ru
  interval: 2026-08-11 16:30:02+03 .. 2026-08-12 09:00:02+03 (16.5 h)
  findings_in_report: 75
- prod1: pgprofile_srv=10_3_81_94_from=2026_08_12_16_00_to=2026_08_13_08.html
  server: tsldd-pprb01138.delta.sbrf.ru
...
- stability: 3/3 (100%) in nt1, nt2, prod1
...
- GUC `idle_in_transaction_session_timeout` → set_nonzero [safety=cautious, impact=medium] current: nt1=0, nt2=0, prod1=0
...
- GUC `shared_buffers` → increase [safety=restart_required, impact=high] current: nt1=504320, nt2=504320, prod1=537600
...
- GUC `effective_cache_size` → review_increase [safety=safe, impact=low] current: nt1=1512960, nt2=1512960, prod1=1512960
...
- GUC `work_mem` → review_decrease_or_role_level [safety=risky, impact=high] current: nt1=16384, nt2=16384, prod1=16384
...
- GUC `checkpoint_completion_target` → review_increase [safety=safe, impact=low] current: nt1=0.5, nt2=0.7, prod1=0.7
...
- GUC `shared_buffers` → review_increase [safety=restart_required, impact=high] current: nt1=504320, nt2=504320, prod1=537600
...
- GUC `work_mem` → review_increase_role_level [safety=risky, impact=high] current: nt1=16384, nt2=16384, prod1=16384
...
- GUC `max_wal_size` → increase [safety=cautious, impact=medium] current: nt1=8192, nt2=12288, prod1=12288
...
- GUC `max_connections` → review_decrease_with_pooler [safety=cautious, impact=high] current: nt1=550, nt2=550, prod1=550
...
- GUC `wal_buffers` → increase [safety=cautious, impact=medium] current: nt1=2048, nt2=2048, prod1=2048
...
- GUC `random_page_cost` → review_decrease_ssd [safety=cautious, impact=medium] current: nt1=2, nt2=2, prod1=2
...
- GUC `effective_io_concurrency` → increase [safety=cautious, impact=low] current: nt1=300, nt2=300, prod1=300
...
- GUC `statement_timeout` → set_nonzero [safety=safe, impact=low] current: nt1=0, nt2=0, prod1=0
...
- GUC `lock_timeout` → set_nonzero [safety=safe, impact=low] current: nt1=0, nt2=0, prod1=0
...
- [warning] autovacuum.table_high_dead_pct: 2/3 — nt1, nt2
- [warning] autovacuum.table_many_dead_tuples: 2/3 — nt1, prod1
- [warning] io.table_growth: 2/3 — nt2, prod1
### Only in one report
#### nt1
